                        ...
                        new YT.Player(playerID, {
                            ...
                            events: {
                                ...
                                onPlaybackQualityChange: function (e) {
                                    ...
                                    var YTPQualityChange =
                                        jQuery.Event('YTPQualityChange');
                ...
                jQuery.getJSON(
                    ...
                    function (data) {
                        ...
                        function parseYTPlayer_data(data) {
                            ...
                            YTPlayer.videoData.thumb_max = data.thumbnails
                                .maxres
                            ...
                            YTPlayer.videoData.thumb_high = data.thumbnails.high
                                ...
                                : null;
                            YTPlayer.videoData.thumb_medium = data.thumbnails
                                .medium
            ...
            YTPlayer.getState = setInterval(function () {
                ...
                if (
                    ...
                    (parseFloat(YTPlayer.player.getDuration() - 1.5) <
                        ...
                        (stopAt > 0 &&
                            parseFloat(YTPlayer.player.getCurrentTime()) >
                                stopAt))
                ) {
        ...
        normalizeCss: function (e) {
            ...
            for (var r in t) {
                'transform' === r &&
                    ...
                    'transform-origin' === r &&
                        ((t[jQuery.CSS.sfx + 'transform-origin'] = e[r]),
                        delete t[r]),
                    'filter' !== r ||
                        jQuery.browser.mozilla ||
                ...
                a.y =
                    'object' == typeof c
                        ? c.clientY +
                          ...
                          this.offset().top
                        : 'number' == typeof c
                          ? ((a.opt.scale - a.opt.initialval - c) * e) /
                            a.opt.scale
