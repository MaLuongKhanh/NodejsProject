!(function (a, b, c, d) {
    ...
    var g = function (b, d) {
        ...
        j = function (b, c) {
            ...
            return 'string' == typeof b
                ...
                : void (g(this.scope).is('[' + this.attr_name() + ']')
                      ...
                      : g('[' + this.attr_name() + ']', this.scope).each(
                            function () {
                                var e = !g(this).data(
                                    d.attr_name(!0) + '-init',
                                );
        ...
        k = function (a, b) {
            ...
            return a.attr('src')
                ? void (a[0].complete || 4 === a[0].readyState
                      ? c()
                      : d.call(a))
                : void c();
        };
    (b.matchMedia =
                    ...
                    ? (this.patch(this.libs[b]),
                      c && c.hasOwnProperty(b)
                          ? ('undefined' != typeof this.libs[b].settings
                            ...
                            this.libs[b].init.apply(this.libs[b], [
                                this.scope,
                                c[b],
                            ]))
            ...
            set_namespace: function () {
                var b =
                    this.global.namespace === d
                        ? a('.foundation-data-attribute-namespace').css(
                              'font-family',
                          )
        ...
        (a.fn.foundation = function () {
            ...
            return this.each(function () {
                return (
                    Foundation.init.apply(Foundation, [this].concat(a)), this
                );
            });
        });
        ...
        Foundation.libs.abide = {
            ...
            check_validation_and_apply_styles: function (b) {
                for (
                    ...
                    i.getAttribute(this.add_namespace('data-equalto')) &&
                        (m = 'equalTo'),
                        ...
                        n && j
                            ...
                            : o && j
                              ...
                              : m
                                ? ((h = this.settings.validators[m].apply(
                                      this,
                                      [i, j, g],
                                  )),
                                  d.push(h),
        ...
        Foundation.libs.clearing = {
                        ...
                        function (c) {
                            if (
                                ...
                                if (
                                    ...
                                    (d.delta_x =
                                        c.touches[0].pageX - d.start_page_x),
            ...
            update_paddles: function (a) {
                ...
                a.next().length > 0
                    ...
                    a.prev().length > 0
                        ? this.S('.clearing-main-prev', b).removeClass(
                              'disabled',
                          )
            ...
            direction: function (a, b, c) {
                var d,
                    ...
                    g =
                        Math.floor(
                            this.S('.clearing-container').outerWidth() / f,
                        ) - 1,
                    h = e.index(c);
                return (
            ...
            events: function () {
                ...
                d(this.scope)
                    ...
                    .on(
                        ...
                        function (b) {
                            var e =
                                d(this).data(c.attr_name(!0) + '-init') ||
                                c.settings;
                    ...
                    .on(
                        ...
                        function (a) {
                            var b = d(this);
                            if (
                                (clearTimeout(c.timeout), b.data(c.data_attr()))
                            )
                            ...
                            var g =
                                f.data(c.attr_name(!0) + '-init') || c.settings;
                            ...
                            c.timeout = setTimeout(
                                function () {
                                    if (a.data(c.data_attr())) {
                                        var b =
                                            a.data(c.data_attr(!0) + '-init') ||
                                            c.settings;
                                        b.is_hover &&
                                            c.close.call(
                                                c,
                                                d('#' + a.data(c.data_attr())),
                                            );
                                    } else {
                                        var e = d(
                                                '[' +
    ...
    (function (a, b) {
        ...
        Foundation.libs.equalizer = {
            ...
            reflow: function () {
                var b = this;
                this.S('[' + this.attr_name() + ']', this.scope).each(
                    function () {
                        var c = a(this);
        ...
        Foundation.libs.joyride = {
            ...
            start: function () {
                ...
                !c.length > 0 ||
                    ...
                    (this.settings.$tip_content =
                        this.settings.$content_el.find('> li')),
                    (this.settings.paused = !1),
                    (this.settings.attempts = 0),
                    'function' != typeof a.cookie &&
                        (this.settings.cookie_monster = !1),
            ...
            button_text: function (b) {
                return (
                    this.settings.next_button
                        ? ((b = a.trim(b) || 'Next'),
                          (b = a(this.settings.template.button).append(b)[0]
                              .outerHTML))
                        : (b = ''),
                    b
                );
            ...
            set_target: function () {
                var b = this.settings.$li.attr(
                        this.add_namespace('data-class'),
                    ),
                ...
                h &&
                    ...
                    /body/i.test(this.settings.$target.selector)
                        ...
                        : (this.bottom()
                          ...
                          !this.visible(
                              this.corners(this.settings.$next_tip),
                          ) &&
                ...
                return (
                    this.settings.$next_tip.css({
                        top:
                            ...
                            c.scrollTop(),
                        left:
                            (c.width() - this.settings.$next_tip.outerWidth()) /
                                2 +
                            c.scrollLeft(),
                    }),
                    !0
    ...
    (function (a, b) {
        ...
        Foundation.libs['magellan-expedition'] = {
            ...
            set_expedition_position: function () {
                var b = this;
                a('[' + this.attr_name() + '=fixed]', b.scope).each(
                    function () {
                        var c,
                            d = a(this),
                            e = d.attr('styles');
            ...
            update_expedition_positions: function () {
                var c = this,
                    d = a(b).scrollTop();
                a('[' + this.attr_name() + '=fixed]', c.scope).each(
                    function () {
                        var b = a(this),
                ...
                (m.cache = {}),
                    ...
                    (m.update_slide_number = function (b) {
                        e.slide_number &&
                            ...
                            e.bullets &&
                                (j
                                    .children()
                                    .removeClass(e.bullets_active_class),
                                a(j.children().get(b)).addClass(
                                    e.bullets_active_class,
                                ));
                    }),
                    ...
                    (m.build_markup = function () {
                        n.wrap('<div class="' + e.container_class + '"></div>'),
                            ...
                            e.stack_on_small &&
                                h.addClass(e.stack_on_small_class),
                            e.navigation_arrows &&
                                (h.append(
                                    a('<a href="#"><span></span></a>').addClass(
                                        e.prev_class,
                                    ),
                                ),
                                h.append(
                            ...
                            e.timer &&
                                ((k = a('<div>').addClass(
                                    e.timer_container_class,
                                )),
                                k.append('<span>'),
                                e.timer_show_progress_bar &&
                                    k.append(
                                        a('<div>').addClass(
                                            e.timer_progress_class,
                                        ),
                                    ),
                    ...
                    (m._goto = function (a, b) {
                        ...
                        if (a === o) return !1;
                        'object' == typeof m.cache.timer &&
                            m.cache.timer.restart();
                        var c = m.slides();
                        m.cache.animating = !0;
                                ...
                                n
                                    .on('touchstart.fndtn.orbit', function (a) {
                                        m.cache.animating ||
                                            ...
                                            a.preventDefault(),
                                            a.stopPropagation(),
                                            (m.cache.start_page_x =
                                                a.touches[0].pageX),
                                            (m.cache.start_page_y =
                                                a.touches[0].pageY),
                                            (m.cache.start_time =
                                                new Date().getTime()),
                                            (m.cache.delta_x = 0),
            ...
            open: function (b, c) {
                ...
                if (!e.hasClass('open')) {
                    ...
                    if (
                        ...
                        var h =
                            'undefined' != typeof c.success ? c.success : null;
                        a.extend(c, {
                ...
                a.data(b, 'bar', a(b).parent()),
                    ...
                    a.data(
                        ...
                        a.extend(
                            {},
                            this.settings,
                            this.data_options(a(b).parent()),
                        ),
                    );
            },
            set_initial_position: function (b) {
                var c = a.data(
                        b.children('.range-slider-handle')[0],
                        'settings',
                    ),
                    d = c.initial
                        ? c.initial
                        : Math.floor((0.5 * (c.end - c.start)) / c.step) *
                              c.step +
                          c.start,
        ...
        Foundation.libs.tooltip = {
                    ...
                    a(this.scope)
                        ...
                        .on(
                            ...
                            function (b) {
                                ...
                                if (e.hasClass('open'))
                                    Modernizr.touch &&
                                        /touchstart|MSPointerDown/i.test(
                                            b.type,
                                        ) &&
                                        b.preventDefault(),
                                        c.hide(e);
                            ...
                            function (b) {
                                return /mouse/i.test(b.type) && c.ie_touch(b)
                                    ...
                                    : void (
                                          ...
                                          /MSPointerDown|touchstart/i.test(
                                              b.type,
                                          )
            ...
            getTip: function (b) {
                ...
                return (
                    c &&
                        (e = this.S(
                            'span[data-selector="' + c + '"]' + d.tooltip_class,
                        )),
                    'object' == typeof e ? e : !1
                );
            },
            ...
            create: function (c) {
                ...
                var g = a(
                        f(
                            this.selector(c),
                            a('<div></div>').html(c.attr('title')).html(),
                        ),
                    ),
            ...
            reposition: function (b, c, d) {
                ...
                if (
                    ...
                    Foundation.rtl &&
                        (f.addClass('rtl'),
                        (j =
                            b.offset().left + b.outerWidth() - c.outerWidth())),
                        i(
                            c,
                            b.offset().top + b.outerHeight() + 10,
                            'auto',
    ...
    (function (a, b, c) {
        ...
        Foundation.libs.topbar = {
            ...
            init: function (b, c, d) {
                Foundation.inherit(
                    this,
                    'add_custom_rule register_media throttle',
                );
                var e = this;
            ...
            toggle: function (c) {
                ...
                d.breakpoint() &&
                    (d.rtl
                        ? (g.css({ right: '0%' }),
                          a('>.name', g).css({ right: '100%' }))
                        : (g.css({ left: '0%' }),
                          a('>.name', g).css({ left: '100%' })),
            ...
            events: function () {
                ...
                d(this.scope)
                    ...
                    d('body')
                        .off('.topbar')
                        .on(
                            'click.fndtn.topbar touchstart.fndtn.topbar',
                            function (a) {
                                var b = d(a.target)
                                    .closest('li')
                                    .closest('li.hover');
